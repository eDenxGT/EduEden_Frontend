...
import { Star, Clock, Users, Globe, Play, FileText, ChevronDown, User2Icon, CopyIcon } from 'lucide-react';
...
const SingleCourseDetails = () => {
  ...
  const isAlreadyPurchased = useSelector((state) =>
    state.student.studentData.active_courses?.some((item) => item === course_id)
  );
                      ...
                      {activeAccordion === index && (
                        <div className="px-4 py-2 border-t">
                          <div className="py-2 flex items-center justify-between text-gray-600 hover:bg-gray-50">
                            <span>Lecture duration : {lecture?.duration}</span>
                          </div>
                        </div>
                      )}
                    </div>
